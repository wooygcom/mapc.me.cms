...
class Parsedown
{
    ...
    /**
	 * 커스터마이징한 것들
	 * 1. function setImagePath 추가
	 * 2. <img src에 $this->imagePath경로도 추가되도록 조정
	 * 3. style="width:100%;" 추가
	 */
            ...
            switch ($closestMarker)
            {
                ...
                case '[':
                    ...
                    if (isset($element))
                    {
                        ...
                        if ($element['!'])
                        {
                            $markup .= '<img alt="'.$element['text'].'" src="'. $this->imagePath .$element['link'].'" style="width:100%;" ';
