...
{ // Model : Head
    ...
    if($mapc_cate != 'tag') { // 출력하려는 화면이 태그일 경우에는 검색이 필요없으므로...
        ...
        { // BLOCK:list_get:20131101:리스트 가져오기
            ...
            $query = "SELECT SQL_CALC_FOUND_ROWS post_uid, post_lang, post_title, post_content, post_origin_type, post_origin_url, post_write_date FROM mapc_post " . $search_query . " ORDER BY post_write_date DESC LIMIT :page, :pageSet ";
        ...
        $query = "
            select postmeta_value as name, count(postmeta_value) as num from mapc_postmeta 
